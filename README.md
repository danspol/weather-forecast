...
You need git to clone the `angular` repository. You can get git from [here][git].

We also use a number of Node.js tools to initialize and test `weather-forcast`. You must have Node.js
and its package manager (npm) installed. You can get them from [here][node].

### Clone `weather-forcast`

Clone the `angular` repository using git:

```
git clone https://github.com/danspol/weather-forecast.git
cd weather-forcast
```

If you just want to start a new project without the `weather-forcast` commit history then you can do:

```
git clone --depth=1 https://github.com/danspol/weather-forecast.git <weather-forcast>
```
...
The `weather-forcast` project supports loading the framework and application scripts asynchronously.
...
The `weather-forcast` project comes preconfigured with a local development web server. It is a Node.js
...
your repository and execute scripts such as building the app or running tests. The `weather-forcast`
